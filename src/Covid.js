  ...
  return (
    <div>
        ...
        <form  onSubmit={getSearch} className="search-form">
          <input className="search-bar" type="text" value={search} placeholder="Enter a Countrys' name Ex: France" onChange={updateSearch}/>
...
<div className={styles.container}>
      ...
      <CardContent>
        ...
        <Typography variant="h4">Deaths today:{data.todayDeaths}</Typography>
